...
<body id="proyectos">
        ...
        <div class="row">
            <div class="col-12 col-sm-4 p-3">
                <div class="to">
                    ...
                    <p class="p-3 pb-5 d-block">Alta, baja y modificacion de un registro de Clientes.Realizando en HTML,CSS,bootstrap,json.</p>
                    <div class="row my-5">
                ...
                <div class="col-12 col-sm-4 p-3 ">
                    <div class="to">
                        ...
                        <p class="p-3 pb-5 d-block">Sistema de gestion de clientes,tos y ventas.Realizando en HTML,CSS,MVC,bootstrap,js,ajax,jQuery,MySQL de base de datos.</p>
                        <div class="row my-5">
                            <div class="col-6 ps-4">
                                <a href="" target="_blank" class="btn btn-rojo">Ver online</a>
                            </div>
    ...
    <div class="whatsapp pt-3 pb-4 px-3">
        <a href="https://api.whatsapp.com/send?phone=541139162663">
